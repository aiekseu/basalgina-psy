...
const data = [
	...
	},
	{
		...
		text:
			'ПТСР, ГТР и не работаю с хроническими психическими расстройствами. я консультирующий психолог с не медицинским образованием.'
	},
	{
		title: 'Если у вас другой запрос',
		text: 'обсуждаю каждый случай отдельно, и при необходимости рекомендую специалиста по вашему запросу.'
	}
];
